...
scanMessage("Digite 1 para ordem crescent ou 0 para ordem decrescente: ")
move $s5,$v0

print_str2("\n")
print_str2("Digite o tamanho do vetor: ")
li $v0,5
syscall
